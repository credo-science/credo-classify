from hit_analysis.commons.consts import DARKNESS, BRIGHTEST, CLASSIFIED, CLASS_ARTIFACT, ARTIFACT_TOO_DARK, IMAGE
from hit_analysis.image.image_utils import measure_darkness_brightest
